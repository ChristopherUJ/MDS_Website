...
<table style="font-size:11px;" width="100%" border="0" cellpadding="5">
  ...
  <tr valign="middle" style="background-color: 
    ...
    <td   style=" border-bottom:1px dashed #CCCCCC; padding:5px;">Services Page </td>
  </tr>
  <tr valign="middle" style="background-color: 
		  ;">
    <td  style=" border-bottom:1px dashed #CCCCCC; vertical-align:middle;"><table width="180" border="0" cellspacing="5" cellpadding="0">
        <tr>
          <td width="117"><table style="display:inline; margin:0px;"  width="142" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="33%" align="center" valign="middle" style=" vertical-align:middle;"><input name="image2" type="image" onclick="window.location ='index.php?con=pageedt&amp;id=4';" src="images/edit.gif" title="Edit" width="22" height="20" /></td>
              </tr>
          </table></td>
        </tr>
    </table></td>
    <td   style=" border-bottom:1px dashed #CCCCCC; padding:5px;">Solutions Page </td>
  </tr>
  <tr valign="middle" style="background-color: 
		  ;">
    <td  style=" border-bottom:1px dashed #CCCCCC; vertical-align:middle;"><table width="180" border="0" cellspacing="5" cellpadding="0">
        <tr>
          <td width="117"><table style="display:inline; margin:0px;"  width="142" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="33%" align="center" valign="middle" style=" vertical-align:middle;"><input name="image22" type="image" onclick="window.location ='index.php?con=pageedt&amp;id=5';" src="images/edit.gif" title="Edit" width="22" height="20" /></td>
              </tr>
          </table></td>
        </tr>
    </table></td>
    <td   style=" border-bottom:1px dashed #CCCCCC; padding:5px;">FAQ Page </td>
  </tr>
</table>
<br />
