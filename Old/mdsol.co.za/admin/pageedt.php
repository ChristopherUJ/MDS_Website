	...
	if (isset($_POST["cg"]))
	{
		...
		if ($err != true)
		{
			...
			if (!$g_db)
				...
				$res3 = update_query("tblpages",array("pageTitle","pageContent","pageLastUpdate"),$vals,"pageID = ".$_POST["edt"]);
				if ($res3 == false)
				{
...
<h1 style="font-size:16px; margin-bottom:15px;"><? echo "Editing "; if ($_GET["id"] == 1) echo "Home"; else if($_GET["id"] == 2) echo "About"; else if($_GET["id"] == 3) echo "Services"; else if($_GET["id"] == 2) echo "Solutions"; else if($_GET["id"] == 2) echo "FAQ"; echo " Page";?>
  :</h1>
